...
class clz_Torappu_LevelData_OptionsT(object):
    ...
    def __init__(
        ...
        self.displayRestTime = displayRestTime  # type: bool
...
class clz_Torappu_AttributesDataT(object):
    ...
    def __init__(
        ...
        self.attractImmune = attractImmune  # type: bool
        self.teleportImmune = teleportImmune  # type: bool
        self.groundBoundImmune = groundBoundImmune  # type: bool
    ...
    def _UnPack(self, clzTorappuAttributesData):
        ...
        self.teleportImmune = clzTorappuAttributesData.TeleportImmune()
        self.groundBoundImmune = clzTorappuAttributesData.GroundBoundImmune()
    ...
    def Pack(self, builder):
        ...
        clz_Torappu_AttributesDataAddTeleportImmune(builder, self.teleportImmune)
        clz_Torappu_AttributesDataAddGroundBoundImmune(builder, self.groundBoundImmune)
...
class clz_Torappu_EnemyDatabase_AttributesDataT(object):
    ...
    def __init__(
        ...
        self.epBreakRecoverSpeed = epBreakRecoverSpeed  # type: Optional[clz_Torappu_Undefinable_1_System_Single_T]
        ...
        self.attractImmune = attractImmune  # type: Optional[clz_Torappu_Undefinable_1_System_Boolean_T]
        self.teleportImmune = teleportImmune  # type: Optional[clz_Torappu_Undefinable_1_System_Boolean_T]
        self.groundBoundImmune = groundBoundImmune  # type: Optional[clz_Torappu_Undefinable_1_System_Boolean_T]
    ...
    def _UnPack(self, clzTorappuEnemyDatabaseAttributesData):
        ...
        if clzTorappuEnemyDatabaseAttributesData.TeleportImmune() is not None:
            self.teleportImmune = clz_Torappu_Undefinable_1_System_Boolean_T.InitFromObj(clzTorappuEnemyDatabaseAttributesData.TeleportImmune())
        if clzTorappuEnemyDatabaseAttributesData.GroundBoundImmune() is not None:
            self.groundBoundImmune = clz_Torappu_Undefinable_1_System_Boolean_T.InitFromObj(clzTorappuEnemyDatabaseAttributesData.GroundBoundImmune())
    ...
    def Pack(self, builder):
        ...
        if self.teleportImmune is not None:
            teleportImmune = self.teleportImmune.Pack(builder)
        if self.groundBoundImmune is not None:
            groundBoundImmune = self.groundBoundImmune.Pack(builder)
        ...
        if self.teleportImmune is not None:
            clz_Torappu_EnemyDatabase_AttributesDataAddTeleportImmune(builder, teleportImmune)
        if self.groundBoundImmune is not None:
            clz_Torappu_EnemyDatabase_AttributesDataAddGroundBoundImmune(builder, groundBoundImmune)
...
class clz_Torappu_CharacterData_MasterInfoT(object):
    ...
    def __init__(
        ...
        self.masterId = masterId  # type: Optional[str]
        self.level = level  # type: int
...
class clz_Torappu_CharacterInst_TalentInstT(object):
    ...
    @classmethod
    def InitFromBuf(cls, buf, pos):
        clzTorappuCharacterInstTalentInst = clz_Torappu_CharacterInst_TalentInst()
        clzTorappuCharacterInstTalentInst.Init(buf, pos)
        return cls.InitFromObj(clzTorappuCharacterInstTalentInst)
    ...
    @classmethod
    def InitFromObj(cls, clzTorappuCharacterInstTalentInst):
        x = clz_Torappu_CharacterInst_TalentInstT()
        x._UnPack(clzTorappuCharacterInstTalentInst)
        return x

    # clz_Torappu_CharacterInst_TalentInstT
    def _UnPack(self, clzTorappuCharacterInstTalentInst):
        if clzTorappuCharacterInstTalentInst is None:
            return
        self.prefabKey = clzTorappuCharacterInstTalentInst.PrefabKey()
        if not clzTorappuCharacterInstTalentInst.BlackboardIsNone():
            self.blackboard = []
            for i in range(clzTorappuCharacterInstTalentInst.BlackboardLength()):
                if clzTorappuCharacterInstTalentInst.Blackboard(i) is None:
                    self.blackboard.append(None)
                else:
                    clz_Torappu_Blackboard_DataPair_ = clz_Torappu_Blackboard_DataPairT.InitFromObj(clzTorappuCharacterInstTalentInst.Blackboard(i))
                    self.blackboard.append(clz_Torappu_Blackboard_DataPair_)
    ...
    def Pack(self, builder):
        ...
        if self.blackboard is not None:
            ...
            for i in range(len(self.blackboard)):
                blackboardlist.append(self.blackboard[i].Pack(builder))
            clz_Torappu_CharacterInst_TalentInstStartBlackboardVector(builder, len(self.blackboard))
            for i in reversed(range(len(self.blackboard))):
                builder.PrependUOffsetTRelative(blackboardlist[i])
            blackboard = builder.EndVector()
        clz_Torappu_CharacterInst_TalentInstStart(builder)
        if self.prefabKey is not None:
            clz_Torappu_CharacterInst_TalentInstAddPrefabKey(builder, prefabKey)
        if self.blackboard is not None:
            clz_Torappu_CharacterInst_TalentInstAddBlackboard(builder, blackboard)
        clzTorappuCharacterInstTalentInst = clz_Torappu_CharacterInst_TalentInstEnd(builder)
        return clzTorappuCharacterInstTalentInst
...
class clz_Torappu_LevelData_PredefinedData_PredefinedCharacterT(object):
    ...
    def __init__(
        ...
        self.masterInfos = masterInfos  # type: Optional[List[clz_Torappu_CharacterData_MasterInfoT]]
        ...
        self.overrideTalents = overrideTalents  # type: Optional[List[clz_Torappu_CharacterInst_TalentInstT]]
    ...
    def _UnPack(self, clzTorappuLevelDataPredefinedDataPredefinedCharacter):
        ...
        if not clzTorappuLevelDataPredefinedDataPredefinedCharacter.OverrideTalentsIsNone():
            self.overrideTalents = []
            for i in range(clzTorappuLevelDataPredefinedDataPredefinedCharacter.OverrideTalentsLength()):
                if clzTorappuLevelDataPredefinedDataPredefinedCharacter.OverrideTalents(i) is None:
                    self.overrideTalents.append(None)
                else:
                    clz_Torappu_CharacterInst_TalentInst_ = clz_Torappu_CharacterInst_TalentInstT.InitFromObj(clzTorappuLevelDataPredefinedDataPredefinedCharacter.OverrideTalents(i))
                    self.overrideTalents.append(clz_Torappu_CharacterInst_TalentInst_)
    ...
    def Pack(self, builder):
        ...
        if self.overrideTalents is not None:
            overrideTalentslist = []
            for i in range(len(self.overrideTalents)):
                overrideTalentslist.append(self.overrideTalents[i].Pack(builder))
            clz_Torappu_LevelData_PredefinedData_PredefinedCharacterStartOverrideTalentsVector(builder, len(self.overrideTalents))
            for i in reversed(range(len(self.overrideTalents))):
                builder.PrependUOffsetTRelative(overrideTalentslist[i])
            overrideTalents = builder.EndVector()
        ...
        if self.overrideTalents is not None:
            clz_Torappu_LevelData_PredefinedData_PredefinedCharacterAddOverrideTalents(builder, overrideTalents)
...
class clz_Torappu_LevelData_PredefinedData_PredefinedCardT(object):
        ...
        if not clzTorappuLevelDataPredefinedDataPredefinedCard.OverrideSkillBlackboardIsNone():
            ...
            for i in range(clzTorappuLevelDataPredefinedDataPredefinedCard.OverrideSkillBlackboardLength()):
                if clzTorappuLevelDataPredefinedDataPredefinedCard.OverrideSkillBlackboard(i) is None:
                    ...
                    self.overrideSkillBlackboard.append(clz_Torappu_Blackboard_DataPair_)
        if not clzTorappuLevelDataPredefinedDataPredefinedCard.OverrideTalentsIsNone():
            self.overrideTalents = []
            for i in range(clzTorappuLevelDataPredefinedDataPredefinedCard.OverrideTalentsLength()):
                if clzTorappuLevelDataPredefinedDataPredefinedCard.OverrideTalents(i) is None:
                    self.overrideTalents.append(None)
                else:
                    clz_Torappu_CharacterInst_TalentInst_ = clz_Torappu_CharacterInst_TalentInstT.InitFromObj(clzTorappuLevelDataPredefinedDataPredefinedCard.OverrideTalents(i))
                    self.overrideTalents.append(clz_Torappu_CharacterInst_TalentInst_)
    ...
    def Pack(self, builder):
        ...
        if self.overrideTalents is not None:
            ...
            for i in range(len(self.overrideTalents)):
                overrideTalentslist.append(self.overrideTalents[i].Pack(builder))
            clz_Torappu_LevelData_PredefinedData_PredefinedCardStartOverrideTalentsVector(builder, len(self.overrideTalents))
            for i in reversed(range(len(self.overrideTalents))):
                builder.PrependUOffsetTRelative(overrideTalentslist[i])
            overrideTalents = builder.EndVector()
        ...
        if self.overrideTalents is not None:
            clz_Torappu_LevelData_PredefinedData_PredefinedCardAddOverrideTalents(builder, overrideTalents)
...
class clz_Torappu_LevelData_PredefinedData_PredefinedTokenCardT(object):
        ...
        if not clzTorappuLevelDataPredefinedDataPredefinedTokenCard.OverrideSkillBlackboardIsNone():
            ...
            for i in range(clzTorappuLevelDataPredefinedDataPredefinedTokenCard.OverrideSkillBlackboardLength()):
                if clzTorappuLevelDataPredefinedDataPredefinedTokenCard.OverrideSkillBlackboard(i) is None:
                    ...
                    self.overrideSkillBlackboard.append(clz_Torappu_Blackboard_DataPair_)
        if not clzTorappuLevelDataPredefinedDataPredefinedTokenCard.OverrideTalentsIsNone():
            self.overrideTalents = []
            for i in range(clzTorappuLevelDataPredefinedDataPredefinedTokenCard.OverrideTalentsLength()):
                if clzTorappuLevelDataPredefinedDataPredefinedTokenCard.OverrideTalents(i) is None:
                    self.overrideTalents.append(None)
                else:
                    clz_Torappu_CharacterInst_TalentInst_ = clz_Torappu_CharacterInst_TalentInstT.InitFromObj(clzTorappuLevelDataPredefinedDataPredefinedTokenCard.OverrideTalents(i))
                    self.overrideTalents.append(clz_Torappu_CharacterInst_TalentInst_)
    ...
    def Pack(self, builder):
        ...
        if self.overrideTalents is not None:
            ...
            for i in range(len(self.overrideTalents)):
                overrideTalentslist.append(self.overrideTalents[i].Pack(builder))
            clz_Torappu_LevelData_PredefinedData_PredefinedTokenCardStartOverrideTalentsVector(builder, len(self.overrideTalents))
            for i in reversed(range(len(self.overrideTalents))):
                builder.PrependUOffsetTRelative(overrideTalentslist[i])
            overrideTalents = builder.EndVector()
        ...
        if self.overrideTalents is not None:
            clz_Torappu_LevelData_PredefinedData_PredefinedTokenCardAddOverrideTalents(builder, overrideTalents)
