...
def build_sample_mod_win(client_version: str, res_version: str):
    res = Resource(client_version, res_version, "Windows")
    ...
    res.build_mod("sample_mod_win")


def main():
    client_version = "2.7.61"
    build_sample_mod_win(client_version, get_last_res_version_windows(client_version))
